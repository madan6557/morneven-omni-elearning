...
type FeedbackContextValue = { showFeedback: (message: string, type?: Feedback["type"]) => void; requestConfirmation: (message: string) => Promise<boolean> };

const FeedbackContext = createContext<FeedbackContextValue>({ showFeedback: () => {}, requestConfirmation: async () => false });
...
export function FeedbackProvider({ children }: { children: ReactNode }) {
  ...
  return <FeedbackContext.Provider value={{ showFeedback, requestConfirmation }}>
    {children}
