...
export default function Manage() {
  ...
  const [quiz, setQuiz] = useState({ moduleId: "", title: "", kind: "PRETEST", showAnswers: false, attemptLimited: true, attemptLimit: 1, questions: [{ text: "", options: ["", ""], correctIndex: 0, imageUrl: "" }] as any[] });
  ...
  const resetQuiz = () => { setEditingQuizId(null); setQuiz((q) => ({ ...q, title: "", showAnswers: false, attemptLimited: true, attemptLimit: 1, questions: [{ text: "", options: ["", ""], correctIndex: 0, imageUrl: "" }] })); };
