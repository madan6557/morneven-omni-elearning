      ...
      {course && (
        <>
          ...
          <details className="group section-card space-y-5">
            ...
            <button onClick={() => { setEditingAssignmentId("new"); setAssignment({ moduleId: course.modules[0]?.id || "", title: "", description: "", deadline: "" }); }} className="primary-button"><Plus size={17} /> Tambah tugas</button>
